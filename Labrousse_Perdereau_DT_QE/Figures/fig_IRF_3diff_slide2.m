function fig_IRF_3diff_slide2(trans_ref, trans1, trans2, trans3, N)
...
for n = 1:N
    ...
    subplot(331) 
    d_CB_diff = 100*[trans1.d_CB; trans2.d_CB; trans3.d_CB]' ;
    SET_Off(d_CB_diff , n) ; title('CB balance sheet (\% GDP)', 'Interpreter','latex') ; 
    A ; ylabel('') ;
    ...
    SET_Off(tau_diff , n) ; title('Tax rate', 'Interpreter','latex') ; A; yline(0,'linewidth',l-3) ;
    ...
    SET_Off(Pi_diff , n) ; title('Inflation', 'Interpreter','latex') ; A;   yline(0,'linewidth',l-3) ;
   
    subplot(334) 
    Phi_diff = 100*([trans1.Profit_CB; trans2.Profit_CB; trans3.Profit_CB]'-trans_ref.Profit_CB') ; 
    SET_Off(Phi_diff , n) ; title('CB profit (\% GDP)', 'Interpreter','latex') ; A;  ylabel('') ; yline(0,'linewidth',l-3) ;   
    
    subplot(335) 
    X_diff = 100*[trans1.X_CB; trans2.X_CB; trans3.X_CB]' ;
    SET_Off(X_diff, n) ; title('CB securities (\% GDP)', 'Interpreter','latex') ; A ; ylabel('') ;  yline(0,'linewidth',l-3) ; 
    
    subplot(336) 
    d_R_diff = 100*([trans1.R; trans2.R; trans3.R]' - trans_ref.R');
    SET_Off(d_R_diff, n) ; title('Real interest rate', 'Interpreter','latex') ; A ;  yline(0,'linewidth',l-3) ;   
