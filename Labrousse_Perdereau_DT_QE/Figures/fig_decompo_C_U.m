function fig_decompo_C_U(p, debut, final, no_QE, IRF) 
...
%DEC = 100*[dev_R ; dev_Pi ; dev_firm ; dev_tau ; dev_residu]./no_QE.C_H ;
...
if 1 == 1
    subplot(2,2,3:4)
    dev_tot = QE.U_H - no_QE.U_H ;
    dev_R = trans_R.U_H - no_QE.U_H ;
    dev_Pi = trans_Pi.U_H - no_QE.U_H ;
    dev_firm = trans_firm.U_H - no_QE.U_H ;
    dev_tau = trans_tau.U_H - no_QE.U_H ;
    dev_sum = dev_R + dev_Pi + dev_firm + dev_tau ;
    dev_residu = dev_tot - dev_sum ;
    
%    DEC = [dev_R ; dev_Pi ; dev_firm ; dev_tau ; dev_residu] ;
    DEC = [dev_R ; dev_Pi ; dev_firm ; dev_tau ] ;
    TOT = dev_tot  ;
    graph_dec 
    title("Utility change decomposition",'Fontsize',30, 'Interpreter', 'latex')
    ...
    function graph_dec
        ...
        ba(1).CData = green; ba(2).CData = red; ba(3).CData = yellow; ba(4).CData = blue; % ba(5).CData = grey;
        ...
        ylabel("\% deviation", 'Fontsize', 25, 'Interpreter', 'latex');
